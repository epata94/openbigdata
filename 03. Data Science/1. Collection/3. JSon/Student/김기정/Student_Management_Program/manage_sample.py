...
while True:
    ...
    if pg_selection == 1:  # 학생 ID는 ITT00X 순서대로 부여
        ...
        student_data = Student_Register.Student_Info(st_name,st_old,st_address)
        class_past_count = str(input("과거 수강 횟수 :\n"))
        Class_Register.Institute_Past_Info(class_past_count)
        while True:
            ...
            institute_data = Class_Register.Institute_Info(class_code,class_name,class_teacher,class_start,class_end)
            print(Class_Register.Institute_Past_Info(class_past_count))
            aggrement = str(input("강의를 추가하시겠습니까? 1/2\n>>"))
            if aggrement == "1" :
                print(1)
                print(institute_data.return_info())
                Class_Register.Institute_Past_Info(class_past_count)["dd"] = institute_data.return_info()
                print(Class_Register.Institute_Past_Info(class_past_count)["dd"])
                print(3)
                continue
            if aggrement == "2" :
                Class_Register.Institute_Past_Info(class_past_count)["강좌" + str(lecture_number)] = institute_data.return_info()
                break

        st_ID = st_ID_Generator()
        st_database["학생ID"] = st_ID
        st_database["학생정보"] = student_data.return_info()
        st_database["수강정보"] = Class_Register.Institute_Past_Info(class_past_count)
                                    ...
                                    if ins_fix_num == 2:
                                        ...
                                        for i in range(len(open_json_file())):
                                            if input_value == open_json_file()[i]["학생ID"]:
                                                for x in range(len(open_json_file()[i]["수강정보"]) - 1):
                                                    print(((("\t" * 12) + "강좌" + str(x + 1)) + " - " + "강의코드" + str(
                                                        x + 1) + ": " + "%s" %
                                                           open_json_file()[i]["수강정보"]["강좌" + str(x)]["강의코드"]) + "\n")
                                                    continue
                                        print("-" * 140)
                                        print("수정할 강좌의 강의 코드를 입력하세요")
                                        fix_code = str(input(":"))
                                        print("-" * 140)
                                        print("")
                                        print(("수정하실 항목을 선택하시오").center(110))
                                        print("")
                                        print(("1.강의명").center(113))
                                        print(("2.강사").center(112))
                                        print(("3.개강일").center(113))
                                        print(("4.종료일").center(113))
                                        print(("5.뒤로가기").center(114))
                                        print("")
                                        print("-" * 140)
